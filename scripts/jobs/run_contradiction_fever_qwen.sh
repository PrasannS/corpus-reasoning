#!/bin/bash
#SBATCH --job-name=contra-fever-qwen
...
#SBATCH --time=6:00:00
#SBATCH --qos=normal
#SBATCH --output=outputs/contra_fever_qwen_%j.log
#SBATCH --error=outputs/contra_fever_qwen_%j.log
set -eo pipefail
...
echo "============================================================"
echo "Contradiction (FEVER): Qwen LoRA, standard attention"
echo "============================================================"
...
CUDA_HOME=/usr/local/cuda-12.8 accelerate launch --num_processes 2 \
    ...
    configs/contradiction_fever_qwen_lora.yml \
    2>&1 | tee outputs/train_contra_fever_qwen.log
